...
const savedTheme = localStorage.getItem('zorko-theme') || 'light';
...
//   {src:"https://res.cloudinary.com/deb6oiddj/image/upload/v1784196388/aww9tviijlzprum3c2rw.jpg",cat:"outdoor",label:"outdoor · Cafe",name:"Outdoor LED Display"},
// ];
...
function submitZorko(){
  ...
  document.querySelectorAll('.ff-error').forEach(e => e.remove());
  document.querySelectorAll('.ff-invalid').forEach(e => e.classList.remove('ff-invalid'));
  function showError(fieldId, msg) {
    const field = document.getElementById(fieldId);
    field.classList.add('ff-invalid');
